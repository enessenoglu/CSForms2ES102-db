...
namespace CSForms2ES102_main
{
    ...
    public partial class NORTHWNDEntities : DbContext
    {
        ...
        [DbFunction("NORTHWNDEntities", "fn_Calisan")]
        public virtual IQueryable<fn_Calisan_Result> fn_Calisan(Nullable<int> empID, Nullable<int> yil)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_Calisan_Result>("[NORTHWNDEntities].[fn_Calisan](@empID, @yil)", empIDParameter, yilParameter);
        }
    
        [DbFunction("NORTHWNDEntities", "fn_GetProduct")]
        public virtual IQueryable<fn_GetProduct_Result> fn_GetProduct(Nullable<int> urunID)
        {
            var urunIDParameter = urunID.HasValue ?
                new ObjectParameter("urunID", urunID) :
                new ObjectParameter("urunID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_GetProduct_Result>("[NORTHWNDEntities].[fn_GetProduct](@urunID)", urunIDParameter);
        }
    
        [DbFunction("NORTHWNDEntities", "fn_ProDetail")]
        public virtual IQueryable<fn_ProDetail_Result> fn_ProDetail(string cusID)
        {
            var cusIDParameter = cusID != null ?
                new ObjectParameter("CusID", cusID) :
                new ObjectParameter("CusID", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_ProDetail_Result>("[NORTHWNDEntities].[fn_ProDetail](@CusID)", cusIDParameter);
        }
